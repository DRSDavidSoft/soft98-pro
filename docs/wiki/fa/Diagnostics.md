...
Soft98 Pro ابزارهای تشخیصی کنسول را زمانی که شرایط صفحه اجازه دهد، در معرض دید قرار می‌دهد.
...
- **`S` با رنگ موفقیت**: وقتی پاک‌سازی موفق باشد اما تم Pro فعال نباشد.
