...
- Restored the bilingual documentation experience with an SVG-first hero, meaningful emoji navigation, stronger first-run guidance, direction-safe Persian copy, and a durable documentation style guide.
